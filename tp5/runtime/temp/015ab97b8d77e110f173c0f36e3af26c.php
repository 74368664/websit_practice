<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:85:"D:\code_progream\php\WWW\tp5\public/../application/wutong\view\AdminDeal\adduser.html";i:1579193163;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div id="ad_main">
    ...
    <div class="ad_content">
        <form method="post" action="<?php echo url('wutong/AdminPage/AddUser'); ?>" method="post" enctype="multipart/form-data">
